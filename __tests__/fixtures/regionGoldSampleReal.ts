...
export const REGION_GOLD_SAMPLES_REAL: RegionGoldSampleReal[] = [
  ...
  },
  {
    ...
    note: "한국형 상병수당 시범사업: real 14-region pilot-program rollout list spanning 10 different provinces and one short district (대구 달서구). This is the densest real multi-region text found in the catalog. The SAME text also contains an unrelated, unresolvable income clause ('기준중위소득 120% 이하') and business clause ('사업자등록') that legitimately land in unresolvedClauses — this fixture only asserts the region rule value, which the region parser gets right independent of those unrelated dimensions.",
  },
